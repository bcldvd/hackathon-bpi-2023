...
1. Run `ng g m features/MODULE_NAME --routing` to generate a features library.
2. Reference new path in [app-routing.module.ts](./src/app/app-routing.module.ts)
3. Then run `ng g component features/MODULE_NAME` to generate the underlying component
